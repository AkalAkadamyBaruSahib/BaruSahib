...
public partial class Admin_Drawing : System.Web.UI.Page
{
    ...
    protected void BindAllDrawing()
    {
        ...
        dsZoneDetails = DAL.DalAccessUtility.GetDataInDataSet(" exec USP_DrwaingShowForAdmin ");
        if (dsZoneDetails.Tables[0].Rows.Count > 0)
        {
            rptDrawings.DataSource = dsZoneDetails;
            rptDrawings.DataBind();
        }
    }
