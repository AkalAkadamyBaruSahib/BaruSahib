<%@ Page Title="" Language="C#" MasterPageFile="~/EmpMaster.master" AutoEventWireup="true" CodeFile="Emp_WorkAlloted.aspx.cs" Inherits="Emp_WorkAlloted" %>
                            ...
                            <tbody>
                                <tr>
                                 ...
                                 <asp:Panel runat="server" ID="pnlAcademy" Visible="false">
                                    ...
                                    <td>
                                        <asp:Button ID="btnBalanceMaterial" Visible="false" runat="server" Text="View Balance Material Details" CssClass="btn btn-primary" OnClick="btnBalanceMaterial_Click" OnClientClick="ClientSideClick(this)" UseSubmitBehavior="False" />
                                    </td>
                                    <td>
