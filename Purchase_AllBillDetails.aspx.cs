...
using System.Data;
public partial class Purchase_AllBillDetails : System.Web.UI.Page
{
    ...
    protected void BillDetails(string id)
    {
        ...
        for (int i = 0; i < dsBillDetails.Tables[0].Rows.Count; i++)
        {
            ...
            ZoneInfo += "<tr><td><b>Bill No.</b> <a  href='Purchase_BillDetails.aspx?BillId=" + dsBillDetails.Tables[0].Rows[i]["SubBillId"].ToString() + "'><span class='label label-important' style='font-size: 15.998px;'>" + dsBillDetails.Tables[0].Rows[i]["SubBillId"].ToString() + "</spam></a></td></tr>";
