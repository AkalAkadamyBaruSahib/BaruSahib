...
public partial class Account_EstimateView : System.Web.UI.Page
{
    ...
    private void GetEstimateDetailsByClick(string id)
    {
        ...
        for (int i = 0; i < dsEstimateDetails.Tables[0].Rows.Count; i++)
        {
            ...
            ZoneInfo += "<tr><td><b>Sub Head:</b> <a href='Account_EstimateView.aspx?EstId=" + dsEstimateDetails.Tables[0].Rows[i]["EstId"].ToString() + "'>" + dsEstimateDetails.Tables[0].Rows[i]["SubEstimate"].ToString() + "</a></td></tr>";
            ...
            {
                ZoneInfo += "<tr><td width='17%'><a href='Account_BillDetails.aspx?SubBillId=" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "'>" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "</a></td><td width='50%'>" + dsBillDetails.Tables[0].Rows[j]["bdATE"].ToString() + "</td><td width='33%'>" + dsBillDetails.Tables[0].Rows[j]["TotalAmount"].ToString() + "</td></tr>";
    ...
    private void getEstimateDetails()
    {
        ...
        for (int i = 0; i < dsEstimateDetails.Tables[0].Rows.Count; i++)
        {
            ...
            ZoneInfo += "<tr><td><b>Work Name:</b> " + dsEstimateDetails.Tables[0].Rows[i]["WorkAllotName"].ToString() + "</td></tr>";
            ZoneInfo += "<tr><td><b>Sanction Date:</b> " + dsEstimateDetails.Tables[0].Rows[i]["dt"].ToString() + "</td></tr>";
            // ZoneInfo += "<tr><td><a class='btn btn-danger' href='Admin_EstimateEdit.aspx?EstId=" + dsEstimateDetails.Tables[0].Rows[i]["EstId"].ToString() + "'><span  style='font-size: 15.998px;'><i class='icon-edit icon-white'></i>Edit Estimate</span></a></td></tr>";
            ZoneInfo += "</table></td>";
            DataSet dsBal = DAL.DalAccessUtility.GetDataInDataSet("exec USP_EstimateBalAmt '" + dsEstimateDetails.Tables[0].Rows[i]["EstId"].ToString() + "'");
            ZoneInfo += "<td width='20%'><table><tr><td> " + dsEstimateDetails.Tables[0].Rows[i]["EstmateCost"].ToString() + "</td></tr><tr><td><b>Bal</b>: " + dsBal.Tables[0].Rows[0]["BalAmt"].ToString() + "</td> </tr> <tr><td><a href='Account_EstimateView.aspx?EstId=" + dsEstimateDetails.Tables[0].Rows[i]["EstId"].ToString() + "'><span class='label label-info'  style='font-size: 15.998px;'>Print Estimate</span></a></td> </tr></table></td>";
            ZoneInfo += "<td width='40%'><table width='100%'>";
            ...
            for (int j = 0; j < dsBillDetails.Tables[0].Rows.Count; j++)
            {
                ZoneInfo += "<tr><td width='33%'><a href='Account_BillDetails.aspx?SubBillId=" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "'>" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "</a></td><td width='34%'>" + dsBillDetails.Tables[0].Rows[j]["bdATE"].ToString() + "</td><td width='33%'>" + dsBillDetails.Tables[0].Rows[j]["TotalAmount"].ToString() + "</td></tr>";
                //if (dsTa.Tables[0].Rows.Count > 0 && dsTa.Tables[1].Rows.Count > 0)
