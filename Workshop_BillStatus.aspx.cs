...
public partial class Workshop_BillStatus : System.Web.UI.Page
{
    ...
    protected void lbMayBill_Click(object sender, EventArgs e)
    {
        ...
        else
        {
            pnlBillMonthDetails.Visible = true;
            DataSet dsBillDetails = new DataSet();
            dsBillDetails = DAL.DalAccessUtility.GetDataInDataSet("exec USP_BillStatusForMonthYearWise4Admin '" + ddlYear.SelectedItem.Text + "','5' ,'" + lblUser.Text + "'");
            divAcademyDetails.InnerHtml = string.Empty;
            string ZoneInfo = string.Empty;
            ZoneInfo += "<div class='box span12'>";
            ZoneInfo += "<div class='box-header well' data-original-title>";
