<%@ Page Language="C#" AutoEventWireup="true"  CodeFile="GrdEditDeleteInsert.aspx.cs" Inherits="_Default" %>
...
<div>
<asp:GridView ID="gvDetails" DataKeyNames="TId,Tname" runat="server" 
...
<asp:ImageButton ID="imgbtnDelete" CommandName="Delete" Text="Edit" runat="server" ImageUrl="~/Example/Images/delete.jpg" ToolTip="Delete" Height="20px" Width="20px" />
</ItemTemplate>
<FooterTemplate>
...
<EditItemTemplate>
<asp:Label ID="lbleditusr" runat="server" Text='<%#Eval("Tname") %>'/>
</EditItemTemplate>
<ItemTemplate>
<asp:Label ID="lblitemUsr" runat="server" Text='<%#Eval("Tname") %>'/>
</ItemTemplate>
<FooterTemplate>
...
<asp:RequiredFieldValidator ID="rfvusername" runat="server" ControlToValidate="txtftrusrname" Text="*" ValidationGroup="validaiton"/>
 ...
 <EditItemTemplate>
 <asp:TextBox ID="txtcity" runat="server" Text='<%#Eval("tMob") %>'/>
 </EditItemTemplate>
 <ItemTemplate>
 <asp:Label ID="lblcity" runat="server" Text='<%#Eval("tMob") %>'/>
 </ItemTemplate>
 <FooterTemplate>
 ...
 <ItemTemplate>
 <asp:Label ID="lblstate" runat="server" Text='<%#Eval("TAddr") %>'/>
 </ItemTemplate>
 <FooterTemplate>
