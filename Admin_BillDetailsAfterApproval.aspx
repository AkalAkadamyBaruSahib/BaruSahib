<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMaster.master" AutoEventWireup="true" CodeFile="Admin_BillDetailsAfterApproval.aspx.cs" Inherits="Admin_BillDetailsAfterApproval" %>
                                            ...
                                            <td colspan="2">
                                               <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        Remarks: <asp:Label ID="lblAccRemark" runat="server" ForeColor="Blue"></asp:Label><br />
                                                        Payment Mode: <asp:Label ID="lbl3rdPayMode" runat="server" ForeColor="#cc66ff"></asp:Label><br />
                                                        Payment Detail: <asp:Label ID="lbl3rdPayDetails" runat="server" ForeColor="#9966ff"></asp:Label>
                                                    </div>
                                                </div>
                                            </td>
