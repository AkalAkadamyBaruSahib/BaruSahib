...
public partial class RateApproved : System.Web.UI.Page
{
    ...
    protected void BindNonApprovedRateMaterial()
    {
        ...
        dsMat = DAL.DalAccessUtility.GetDataInDataSet("Select M.MatId,MT.MatTypeName,M.MatName,M.MatCost,U.UnitName,Inc.InName,MN.CreatedOn,MN.MRP,MN.Discount,MN.Vat,MN.NetRate,V.VendorAddress,V.VendorName from Material M INNER JOIN MaterialNonApprovedRate MN on M.MatId = MN.MatID INNER JOIN MaterialType MT on M.MatTypeId = MT.MatTypeId INNER JOIN Unit U On M.UnitId = U.UnitId INNER JOIN Incharge Inc On MN.CreatedBy = Inc.InchargeId LEFT OUTER JOIN VendorInfo V On V.ID = MN.VendorID");
    ...
    protected void btn_Approved_Click(object sender, EventArgs e)
    {
        ...
        materialrateapproved.ApprovedRate = Convert.ToDecimal(lblNewRate.Text);
        ...
        SendAutoGeneratedApprovedRateEmail(dsMat.Rows[0]["MatName"].ToString(), lblNewRate.Text, dsNonMat.Rows[0]["LoginId"].ToString());
    ...
    public void SendAutoGeneratedRejectedRateEmail(string Material, string RejectedRate, string loginID)
    {
        ...
        MsgInfo += "<tr>";
        MsgInfo += "<td colspan='2' style='height:50px'>";
        MsgInfo += "New Rate for Materials Rejected By Purchase Committee.Please click on <a href='http://akalsewa.org/'>Akal Sewa</a>";
        MsgInfo += "</td>";
        MsgInfo += "</tr>";
        MsgInfo += "</table>";
        ...
        MsgInfo += "<tr>";
        MsgInfo += "<td>";
        MsgInfo += "<b>Rejected Rate:</b>";
        MsgInfo += "</td>";
        MsgInfo += "<td>";
        MsgInfo += RejectedRate;
        MsgInfo += "</td>";
        MsgInfo += "</tr>";
        MsgInfo += "</tbody>";
        MsgInfo += "</table>";
