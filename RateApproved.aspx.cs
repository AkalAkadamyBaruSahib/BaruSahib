...
public partial class RateApproved : System.Web.UI.Page
{
    ...
    protected void btn_Approved_Click(object sender, EventArgs e)
    {
        ...
        SendAutoGeneratedApprovedRateEmail(dsMat.Rows[0]["MatName"].ToString(), txtNewRate.Text, dsNonMat.Rows[0]["LoginId"].ToString());
    ...
    protected void btn_Rejected_Click(object sender, EventArgs e)
    {
        ...
        SendAutoGeneratedRejectedRateEmail(dsNonMat.Rows[0]["MatName"].ToString(), txtNewRate.Text, dsNonMat.Rows[0]["LoginId"].ToString());
