...
(function(a, b) {
    ...
    a.extend(a.ui, {
        ...
        scrollParent: function() {
            var b;
            return /(static|relative)/.test(this.css("position")) || /absolute/.test(this.css("position")) ? b = this.parents().filter(function() {
...
(function(a, b) {
    ...
    a(document).mouseup(function(a) {
        ...
        _mouseMove: function(b) {
            return document.documentMode >= 9 || !!b.button ? this._mouseStarted ? (this._mouseDrag(b), b.preventDefault()) : (this._mouseDistanceMet(b) && this._mouseDelayMet(b) && (this._mouseStarted = this._mouseStart(this._mouseDownEvent, b) !== !1, this._mouseStarted ? this._mouseDrag(b) : this._mouseUp(b)), !this._mouseStarted) : this._mouseUp(b)
        },
        _mouseUp: function(b) {
    ...
    a.widget("ui.resizable", a.ui.mouse, {
        ...
        _proportionallyResize: function() {
            ...
            for (var d = 0; d < this._proportionallyResizeElements.length; d++) {
                ...
                if (!a(c).is(":hidden") && !a(c).parents(":hidden").length) e.css({
...
(function(a, b) {
    ...
    a.widget("ui.dialog", {
        ...
        height: function() {
            var b, c;
            return 1!=1 ? (b = Math.max(document.documentElement.scrollHeight, document.body.scrollHeight), c = Math.max(document.documentElement.offsetHeight, document.body.offsetHeight), b < c ? a(window).height() + "px" : b + "px") : a(document).height() + "px"
        },
        width: function() {
            var b, c;
            return 1!=1 ? (b = Math.max(document.documentElement.scrollWidth, document.body.scrollWidth), c = Math.max(document.documentElement.offsetWidth, document.body.offsetWidth), b < c ? a(window).width() + "px" : b + "px") : a(document).width() + "px"
        },
        resize: function() {
            var b = a([]);
