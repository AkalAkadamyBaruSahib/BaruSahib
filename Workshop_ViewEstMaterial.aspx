        ...
        <div class="box-content">
            <asp:GridView runat="server" AutoGenerateColumns="false" DataKeyNames="EstId" ID="gvMaterailDetailForPurchase"
                ...
                <Columns>
                    <asp:TemplateField>
                        <HeaderTemplate>
                            <asp:CheckBox ID="chkboxSelectAll" Text="Select All" OnCheckedChanged="chkboxSelectAll_CheckedChanged" Font-Bold="true" AutoPostBack="true" TextAlign="right" runat="server" />
                        </HeaderTemplate>
                        <ItemTemplate>
