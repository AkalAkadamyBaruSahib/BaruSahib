                        ...
                        <tr>
                            <td>
                                <table  style="border-radius:25px; background: #ddd; padding: 20px; width: 200px; height: 150px; margin-left: 75px; float: left;">
                                    ...
                                    <tr>
                                        <td style="width: 70px; float: left; margin-left: 153px; margin-top: 5px;"></td>
                                        <td>
                                            <asp:TextBox ID="txtrs" runat="server" Style="width: 220px; visibility:hidden; float: right; margin-right: 462px;"></asp:TextBox>
                                      </tr>
                                </table>
                            </td>
                        </tr>
