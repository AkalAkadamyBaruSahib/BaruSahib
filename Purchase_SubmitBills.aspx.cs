...
using System.Data;
public partial class Purchase_SubmitBills : System.Web.UI.Page
{
    decimal m = 0;
    ...
    protected void BindNameOfWork()
    {
        ...
        dsWa = DAL.DalAccessUtility.GetDataInDataSet("select WAId,WorkAllotName from WorkAllot where AcaId ='" + ddlAcademy.SelectedValue + "' and Active=1");
        ...
        if (ViewState["CurrentAddItemTable"] != null)
        {
            ...
            if (dtCurrentTable.Rows.Count > 0)
            {
                for (int i = 1; i <= dtCurrentTable.Rows.Count; i++)
                {
                    ...
                    Label box4 = (Label)gvAddItems.Rows[rowIndex].Cells[4].FindControl("lblUnit");
    ...
    protected void ddlMatType_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        Label ddlUni = (Label)row.FindControl("lblUnit");
    ...
    protected void btnSave_Click(object sender, EventArgs e)
    {
        ...
        if (ddlBillType1.SelectedValue == "2")
        {
            ...
            else
            {
                ...
                foreach (GridViewRow gvrow in gvAddItems.Rows)
                {
                    ...
                    Label ddlun = (Label)gvAddItems.Rows[rowindex].FindControl("lblUnit");
                    ...
                    //DAL.DalAccessUtility.ExecuteNonQuery("exec USP_NewMaterialAndUnitByUser '" + Uni + "','" + lblUser.Text + "','" + Itm + "'");
                    if (txtItem.Text != "")
                    {
                        DAL.DalAccessUtility.ExecuteNonQuery("exec USP_NewMaterialAndUnitByUser '" + Uni + "','" + lblUser.Text + "','" + Itm + "'");
        ...
        else if (ddlBillType1.SelectedValue == "1")
        {
            ...
            else
            {
                ...
                foreach (GridViewRow gvrow in gvAddItems2.Rows)
                {
                    ...
                    dsValidation = DAL.DalAccessUtility.GetDataInDataSet("exec USP_QtyAndRateValidation_New '" + ddlEsimate.SelectedValue + "','" + MatId + "','2'");
        ...
        Response.Redirect("Purchase_BillDetails.aspx?BillId=" + dsBillId.Tables[0].Rows[0]["NewBillId"].ToString() + "");
    ...
    protected void BindMat()
    {
        ...
        dsAcademy = DAL.DalAccessUtility.GetDataInDataSet("exec USP_getEstimateBalance '" + ddlEsimate.SelectedValue + "','2'");
    ...
    protected void BindEstimate()
    {
        //string AcaId = Request.QueryString["AcaId"];
        DataSet dsAcademy = new DataSet();
        dsAcademy = DAL.DalAccessUtility.GetDataInDataSet("exec USP_EstimateNo '" + ddlAcademy.SelectedValue + "'");
        ...
        foreach (GridViewRow row in GridView1.Rows)
        {
            if (row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (chkRow.Checked)
                {
                    ...
                    dr["EstQty"] = row.Cells[5].Text;
                    dr["EstRate"] = row.Cells[6].Text;
                    dr["BalQty"] = row.Cells[7].Text;
                    dt.Rows.Add(dr);
    ...
    protected void txtQty_TextChanged(object sender, EventArgs e)
    {
        ...
        DataSet dsValidation = new DataSet();
        //dsValidation = DAL.DalAccessUtility.GetDataInDataSet("exec USP_QtyAndRateValidation '" + lblMId.Text + "','" + ddlEsimate.SelectedValue + "','" + lblUser.Text + "',''");
        dsValidation = DAL.DalAccessUtility.GetDataInDataSet("exec USP_QtyAndRateValidation_New '" + ddlEsimate.SelectedValue + "','" + lblMId.Text + "','2'");
        decimal EstQty = Convert.ToDecimal(dsValidation.Tables[0].Rows[0]["EstBal"].ToString());
    ...
    {
        BindNameOfWork();
        lblNameOfWork.Text = ddlNameOfWork.SelectedItem.Text;
    }
}