...
public partial class Admin_AcademiesDetails : System.Web.UI.Page
{
    ...
    private void getAcaDetails(string ID)
    {
        ...
        dsAcaDetails = DAL.DalAccessUtility.GetDataInDataSet("exec USP_AcademayWithZone '" + lblUser.Text + "','" + ID + "',1");
        ...
        string ZoneInfo = string.Empty;
                    ...
                    for (int i = 0; i < dsAcaDetails.Tables[0].Rows.Count; i++)
                    {
                        ...
                        if (dsAcaDetails.Tables[1].Rows.Count > 0)
                        {
                            ...
                            {
                                ZoneInfo += "<tr><td><b><a href='Admin_EstimateView.aspx?AcaId=" + dsAcaDetails.Tables[0].Rows[i]["AcaId"].ToString() + "'>Estimate(" + dsCount.Tables[0].Rows[j]["EstCount"].ToString() + ")</a></b></td></tr>";
                                ZoneInfo += "<tr><td><b><a href='Admin_WorkAllot.aspx?AcaId=" + dsAcaDetails.Tables[0].Rows[i]["AcaId"].ToString() + "'>Work Allot(" + dsCount.Tables[1].Rows[j]["WACount"].ToString() + ")</a></b></td></tr>";
                                ZoneInfo += "<tr><td><b><a href='Admin_AllBillDetails.aspx?AcaId=" + dsAcaDetails.Tables[0].Rows[i]["AcaId"].ToString() + "'>Bills(" + dsCount.Tables[2].Rows[j]["BillCount"].ToString() + ")</a></b></td></tr>";
                            }
                        }
                        else
                        {
