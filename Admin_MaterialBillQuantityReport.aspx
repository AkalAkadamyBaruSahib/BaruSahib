                ...
                <div class="box-content">
                    ...
                    <table border="0" width="100%">
                        <tbody>
                            <tr>
                                <td>Select Zone:
                             <asp:DropDownList ID="ddlZone" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlZone_SelectedIndexChanged" Style="margin-right: 830px; float: right; margin-top: -22px;">
                             <asp:ListItem Value="0">--Select Zone--</asp:ListItem></asp:DropDownList>
                              <asp:RequiredFieldValidator ID="reqZone" ControlToValidate="ddlZone" Display="None" runat="server" ForeColor="Red" ValidationGroup="report" ErrorMessage="Please select the Zone." InitialValue="0"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>Select Academy:
                                <asp:DropDownList ID="ddlAcademy" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlAcademy_SelectedIndexChanged" Style="margin-right: 830px; float: right; margin-top: -22px;">
                                <asp:ListItem Value="0">--Select Academy--</asp:ListItem></asp:DropDownList>
                            ...
                            <tr>
                              ...
                              <asp:DropDownList ID="ddlNameOfWork" runat="server" Style=" margin-top: -22px; margin-right: 830px; float: right;">
                               <asp:ListItem Value="0">--Select Name Of Work--</asp:ListItem></asp:DropDownList>
