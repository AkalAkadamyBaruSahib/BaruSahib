...
using System.Data;
public partial class Workshop_WorkWiseBill : System.Web.UI.Page
{
    ...
    protected void ddlWork_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        dsBillDetails = DAL.DalAccessUtility.GetDataInDataSet("exec USP_BillStatusWorkWise '" + ddlWork.SelectedValue + "'");
        divAcademyDetails.InnerHtml = string.Empty;
        string ZoneInfo = string.Empty;
        ZoneInfo += "<div class='box span12'>";
        ZoneInfo += "<div class='box-header well' data-original-title>";
        ZoneInfo += "<h2><i class='icon-user'></i> "+ ddlWork.SelectedItem.Text +" Bill List</h2>";
    ...
    protected void BindWork()
    {
        ...
        dsWork = DAL.DalAccessUtility.GetDataInDataSet("select WAId,WorkAllotName from WorkAllot where Active=1");
        ddlWork.DataSource = dsWork;
        ddlWork.DataValueField = "WAId";
        ddlWork.DataTextField = "WorkAllotName";
        ddlWork.DataBind();
        ddlWork.Items.Insert(0, "Select Work Allot");
    ...
    private void getBillDetails()
    {
        pnlBillMonthDetails.Visible = true;
        DataSet dsBillDetails = new DataSet();
        dsBillDetails = DAL.DalAccessUtility.GetDataInDataSet("exec USP_BillVarificationDEtailsByZoneWiseForPurchase ");
        divAcademyDetails.InnerHtml = string.Empty;
        string ZoneInfo = string.Empty;
        ZoneInfo += "<div class='box span12'>";
        ZoneInfo += "<div class='box-header well' data-original-title>";
        ZoneInfo += "<h2><i class='icon-user'></i> All Bill List</h2>";
        ZoneInfo += "<div class='box-icon'>";
        //ZoneInfo += "<a href='#' class='btn btn-setting btn-round'><i class='icon-cog'></i></a>";
        ZoneInfo += "<a href='#' class='btn btn-minimize btn-round'><i class='icon-chevron-up'></i></a>";
        ZoneInfo += "<a href='#' class='btn btn-close btn-round'><i class='icon-remove'></i></a>";
