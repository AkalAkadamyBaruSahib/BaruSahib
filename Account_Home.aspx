<%@ Page Title="" Language="C#" MasterPageFile="~/AccountMaster.master" AutoEventWireup="true" CodeFile="Account_Home.aspx.cs" Inherits="Account_Home" %>
            ...
            <div class="row-fluid">
				<div class="box span12">
					...
					<div class="box-content">
						...
						<p><b>In This organisation you'r as <asp:Label runat="server" ID="lblDesignation" Text="Account Office" ForeColor="Blue"></asp:Label>, and we were assign you these location <asp:Label ID="lblLocation" runat="server" Text="zone name" ForeColor="Violet"></asp:Label></b></p>
