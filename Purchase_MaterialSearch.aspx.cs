...
public partial class Purchase_MaterialSearch : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        {
            ZoneInfo += "<tr>";
            ZoneInfo += "<td width='20%'><table><tr><td><b><span style='color:#cc3300;'>Estimate No:</span></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + dsMaterialDetails.Tables[0].Rows[i]["EstId"].ToString() + "</td></tr><tr><td><b><span style='color:#cc3300;'>Vendor Name:</span></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + dsMaterialDetails.Tables[0].Rows[i]["VendorName"].ToString() + "</td></tr><tr><td><b><span style='color:#cc3300;'>Vendor Address:</span></b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;" + dsMaterialDetails.Tables[0].Rows[i]["VendorAddress"].ToString() + "</td></tr><tr><td><b><span style='color:#cc3300;'>Vendor Contact No:</span></b>&nbsp;&nbsp;" + dsMaterialDetails.Tables[0].Rows[i]["VendorContactNo"].ToString() + "</td></tr></table></td>";
