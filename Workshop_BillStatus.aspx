<%@ Page Title="" Language="C#" MasterPageFile="~/Workshop.master" AutoEventWireup="true" CodeFile="Workshop_BillStatus.aspx.cs" Inherits="Workshop_BillStatus" %>
                        ...
                        <tr>
                            <td colspan="23">
                                Select Year: <asp:DropDownList ID="ddlYear" runat="server" Width="125px">
                                 ...
                                 &nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;
                                <a href="Workshop_ZoneAcaWiseBill.aspx"><span class="label label-info" style="font-size:medium;">Zone & Academy Wise</span></a>
                                 &nbsp;&nbsp;&nbsp;
                                <a href="Workshop_PaidBills.aspx"><span class="label label-info" style="font-size:medium;">Paid Bills</span></a>
                                 &nbsp;&nbsp;&nbsp;
                                <a href="Workshop_WorkWiseBill.aspx"><span class="label label-info" style="font-size:medium;">Work Wise Bills</span></a>
                                 &nbsp;&nbsp;&nbsp;
