...
using System.Data;
public partial class Audit_BillsZoneAcademyWise : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            ZoneInfo += "<h2><i class='icon-user'></i> Current Month and Year Bill List</h2>";
    ...
    protected void BindZone()
    {
        ...
        dsZone = DAL.DalAccessUtility.GetDataInDataSet(" exec  USP_BIndAuditZone '" + lblUser.Text + "'");
    ...
    protected void ddlZone_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        dsAca = DAL.DalAccessUtility.GetDataInDataSet(" exec  USP_AuditBindAcademy '"+ ddlZone.SelectedValue +"', '" + lblUser.Text + "'");
    ...
    protected void ddlAcademy_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ZoneInfo += "<div class='box span12'>";
        ZoneInfo += "<div class='box-header well' data-original-title>";
        ZoneInfo += "<h2><i class='icon-user'></i> "+ ddlAcademy.SelectedItem.Text +" Academy Wise Bill List</h2>";
        ZoneInfo += "<div class='box-icon'>";
        //ZoneInfo += "<a href='#' class='btn btn-setting btn-round'><i class='icon-cog'></i></a>";
        ZoneInfo += "<a href='#' class='btn btn-minimize btn-round'><i class='icon-chevron-up'></i></a>";
        ZoneInfo += "<a href='#' class='btn btn-close btn-round'><i class='icon-remove'></i></a>";
