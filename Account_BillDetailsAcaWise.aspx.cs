...
using System.Data;
public partial class Account_BillDetailsAcaWise : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            if (Request.QueryString["AcaId"] != null)
            {
                ...
                dsBillDetails = DAL.DalAccessUtility.GetDataInDataSet("exec USP_BillStatusAcaWise  '" + Request.QueryString["AcaId"].ToString() + "'");
