<%@ Page Title="" Language="C#" MasterPageFile="~/EmpMaster.master" AutoEventWireup="true" CodeFile="Emp_BillWorkAllotWise.aspx.cs" Inherits="Emp_BillWorkAllotWise" %>
     ...
     <div class="row-fluid sortable">		
				<div class="box span12">
					...
					<div class="box-content">
                        ...
                        <tr>
                            <td >
                                Select Work Allot: <asp:DropDownList runat="server" ID="ddlAllot" OnSelectedIndexChanged="ddlAllot_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
