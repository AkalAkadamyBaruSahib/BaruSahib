...
using System.Data;
public partial class Account_BillWorkAllotWise : System.Web.UI.Page
{
    ...
    protected void ddlWork_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        ZoneInfo += "<div class='box span12'>";
        ZoneInfo += "<div class='box-header well' data-original-title>";
        ZoneInfo += "<h2><i class='icon-user'></i> "+ ddlWork.SelectedItem.Text +" Bill Status</h2>";
        ZoneInfo += "<div class='box-icon'>";
        //ZoneInfo += "<a href='#' class='btn btn-setting btn-round'><i class='icon-cog'></i></a>";
        ZoneInfo += "<a href='#' class='btn btn-minimize btn-round'><i class='icon-chevron-up'></i></a>";
        ZoneInfo += "<a href='#' class='btn btn-close btn-round'><i class='icon-remove'></i></a>";
        ...
        for (int i = 0; i < dsBillDetails.Tables[0].Rows.Count; i++)
        {
            ...
            {
                ZoneInfo += "<span class='label label-important' style='font-size: 15.998px;'>Rejected</span>";
            }
            ZoneInfo += "</td>";
            ZoneInfo += "<td class='center' width='13%' align='center'>";
            if (dsBillDetails.Tables[0].Rows[i]["AuditStatus"].ToString() == "1")
            ...
            {
                ZoneInfo += "<span class='label label-important' style='font-size: 15.998px; coloe:Dark-Red;'>Rejected</span>";
            }
            ZoneInfo += "</td>";
            ZoneInfo += "</tr>";
        }
