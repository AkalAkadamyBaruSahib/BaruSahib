...
SELECT     SubmitBillByUser.SubBillId,SubmitBillByUser.WAId, CONVERT(nvarchar(20), SubmitBillByUser.BillDate, 107) AS BillDate, SubmitBillByUser.TotalAmount,SubmitBillByUser.AgencyName AS AgencyName,         
