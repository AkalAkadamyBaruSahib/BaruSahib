...
@AdditionalDiscount as decimal(18,2),
...
insert into Material(MatTypeId,MatName,MatCost,CreatedOn,CreatedBy,Active,UnitId,ImageUrl,LocalRate,AkalWorkshopRate,Discount,Vat,MRP,AdditionalDiscount,GST) values(@MatTypeId,upper(@MatName),@MatCost,GETDATE(),@CreatedBy,@Active,@UnitId,@ImageUrl,@LocalRate,@AkalWorkshopRate,@Discount,@Vat,@MRP,@AdditionalDiscount,@GST)              
