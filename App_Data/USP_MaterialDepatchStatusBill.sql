ALTER procedure [dbo].[USP_MaterialDepatchStatusBill]  
   (  
   @EstId as int  
    )      
as            
begin            
SELECT DISTINCT Estimate.SubEstimate,Z.ZoneName, CONVERT(nvarchar(20), Estimate.ModifyOn, 107) AS SanctionDate, Academy.AcaName, Estimate.EstId,Incharge.InName,Incharge.InMobile    
