...
FROM         Drawing INNER JOIN      
			 	...
			 	inner join  Incharge inc on inc.inchargeID=Drawing.CreatedBy 
					  ...
					  WHERE Drawing.Active=1  and  Drawing.AcaId = @AcaId and Drawing.DwTypeId = @DrwingTypeID and  Drawing.IsApproved = @IsApproved AND Drawing.CreatedBy = @CreatedBy
...
FROM         Drawing INNER JOIN      
			 	...
			 	inner join  Incharge inc on inc.inchargeID=Drawing.CreatedBy 
					  ...
					  WHERE Drawing.Active=1  and  Drawing.DwTypeId = @DrwingTypeID and  Drawing.IsApproved = @IsApproved AND Drawing.CreatedBy = @CreatedBy
