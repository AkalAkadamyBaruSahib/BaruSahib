CREATE PROCEDURE [dbo].[USP_NewStockReport] --2     
...
WHERE ER.PSId=@PSID AND Estimate.IsApproved=1  and Estimate.CreatedOn >= @Firstdate and Estimate.CreatedOn <= @SecondDate
