...
as  
begin  
SELECT     SubmitBillByUser.SubBillId, Zone.ZoneName, Academy.AcaName, SubmitBillByUser.BillType, SubmitBillByUser.AgencyName, SubmitBillByUser.TotalAmount, 
                      ...
                      SubmitBillByUser.CreatedBy AS BillSubmitedBy
