ALTER PROCEDURE [dbo].[USP_EstimateWithMaterialForEmp_V2]   
...
SELECT     Estimate.EstId,  Material.MatName, PurchaseSource.PSName,   
                      ...
                      EstimateAndMaterialOthersRelations.Qty AS EstQty,   
...
select SUM(Amount) as Ttl from EstimateAndMaterialOthersRelations where EstId=@EstId 
