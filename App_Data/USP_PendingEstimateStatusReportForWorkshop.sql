...
WHERE E.IsApproved=1 AND m.PSId=@PsId AND E.ModifyOn >= @StartDate and E.ModifyOn <= @EndDate and M.PurchaseEmpID in (select * from [dbo].[Split](@Userid,',')) and M.DispatchStatus = 0
