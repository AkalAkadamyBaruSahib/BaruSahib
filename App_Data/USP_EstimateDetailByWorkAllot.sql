CREATE procedure [dbo].[USP_EstimateDetailByWorkAllot]          
...
SELECT    distinct Estimate.EstId, Estimate.EstmateCost, Estimate.SubEstimate, Zone.ZoneName, Academy.AcaName,   
