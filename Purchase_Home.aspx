                        ...
                        <tr>
                            <td>
                                <div style="text-align: center;">
                                    ...
                                    <div runat="server" id="divPendingItem" style="width: 100%; height: 700px; overflow-y: auto"></div>
                                </div>
                            </td>
                            <td style="width: 5%"></td>
                            <td>
                                <div style="text-align: center;">
                                    ...
                                    <span id="spnRateAproved" runat="server" style="font-weight: bolder; font-size: 20px;"><u>Recent Rate Approved</u></span>
                                    <div runat="server" id="divRecentRateApproved" style="width: 100%; height: 200px; overflow-y: auto"></div>
                                </div>
                                <br />
                                <div style="text-align: center;">
                                    <span id="spnNewRate" runat="server" style="font-weight: bolder;text-align: center; font-size: 20px;"><u>New Rate</u></span>
                                    <div runat="server" id="divNonApprovedRate" style="width: 100%; height: 200px; overflow-y: auto"></div>
                                </div>
                                <br />
                                <div id="divPurchaserPending" style="text-align: center;" runat="server">
                                    ...
                                    <div runat="server" id="divPurchaserPendingItems" style="width: 100%; height: 230px; overflow-y: auto"></div>
                                </div>
