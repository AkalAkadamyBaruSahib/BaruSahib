...
public partial class Workshop_EstimateView : System.Web.UI.Page
{
    ...
    private void GetEstimateDetailsByClick(string id)
    {
        ...
        for (int i = 0; i < dsEstimateDetails.Tables[0].Rows.Count; i++)
        {
            ...
            ZoneInfo += "<tr><td><b>Sub Head:</b> <a href='Workshop_ParticularEstView.aspx?EstId=" + dsEstimateDetails.Tables[0].Rows[i]["EstId"].ToString() + "'>" + dsEstimateDetails.Tables[0].Rows[i]["SubEstimate"].ToString() + "</a></td></tr>";
            ...
            {
                ZoneInfo += "<tr><td width='17%'><a href='Workshop_BillDetails.aspx?BillId=" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "'>" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "</a></td><td width='50%'>" + dsBillDetails.Tables[0].Rows[j]["bdATE"].ToString() + "</td><td width='33%'>" + dsBillDetails.Tables[0].Rows[j]["TotalAmount"].ToString() + "</td></tr>";
    ...
    private void getEstimateDetails()
    {
        ...
        for (int i = 0; i < dsEstimateDetails.Tables[0].Rows.Count; i++)
        {
            ...
            for (int j = 0; j < dsBillDetails.Tables[0].Rows.Count; j++)
            {
                ZoneInfo += "<tr><td width='33%'><a href='Workshop_BillDetails.aspx?BillId=" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "'>" + dsBillDetails.Tables[0].Rows[j]["SubBillId"].ToString() + "</a></td><td width='34%'>" + dsBillDetails.Tables[0].Rows[j]["bdATE"].ToString() + "</td><td width='33%'>" + dsBillDetails.Tables[0].Rows[j]["TotalAmount"].ToString() + "</td></tr>";
                //if (dsTa.Tables[0].Rows.Count > 0 && dsTa.Tables[1].Rows.Count > 0)
