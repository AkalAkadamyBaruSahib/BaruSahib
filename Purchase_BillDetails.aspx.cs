...
using System.Data;
public partial class Purchase_BillDetails : System.Web.UI.Page
{
    ...
    protected void ShowBillDetails(string ID)
    {
        ...
        {
            BillInfo += "<tr>";
            BillInfo += "<td colspan='7'><a href='Purchase_ParticularEstView.aspx?EstId=" + dsBill.Tables[0].Rows[0]["EstId"].ToString() + "'>View Estimate Details</a> </td>";
            BillInfo += "</tr>";
        }
