...
function AutoCadFileFileUpload2() {
    ...
    while (start < SIZE) {
        ...
        //    data.append(files[i].name, files[i]);
        //}
        data.append(completed, chunk);

        $.ajax({
            url: "AutoCadFileFileUploadHandlerTest.ashx?count=" + completed,
            type: "POST",
            async: false,
            data: data,
            contentType: false,
...
function PDFFileFileUpload2() {
    ...
    while (start < SIZE) {
        ...
        $.ajax({
            url:  "PDFFileFileUploadHandlerTest.ashx?count=" + completed,
            type: "POST",
            async: false,
            data: data,
            contentType: false,
