...
public partial class Admin_UserControls_BodyAdmin_ParticularEstimateView : System.Web.UI.UserControl
{
    ...
    private void getEstimateWithParticularDetails(string ID)
    {
        ...
        Session["EstId"] = dsAcaDetails.Tables[0].Rows[0]["EstId"].ToString();
        ...
        ZoneInfo += "<th width='15%'>Material Type</th>";
        ZoneInfo += "<th width='15%'>Material</th>";
        ...
        ZoneInfo += "<th width='25%'>Remark</th>";
        ZoneInfo += "</tr>";
        //ZoneInfo += "<tr>";
        ...
        for (int i = 0; i < dsAcaDetails.Tables[0].Rows.Count; i++)
        {
            ...
            ZoneInfo += "<td width='15%'>" + dsAcaDetails.Tables[0].Rows[i]["MatTypeName"].ToString() + "</td>";
            ZoneInfo += "<td width='15%'><a href='Admin_MaterialDetails.aspx?MatId=" + dsAcaDetails.Tables[0].Rows[i]["MatId"].ToString() + "'>" + dsAcaDetails.Tables[0].Rows[i]["MatName"].ToString() + "</a></td>";
            ...
            {
                ZoneInfo += "<td width='25%'><span class='label label-success'>No Data</span></td>";
            }
            else
            {
                ZoneInfo += "<td width='25%'>" + dsAcaDetails.Tables[0].Rows[i]["Remark"].ToString() + "</td>";
            }
