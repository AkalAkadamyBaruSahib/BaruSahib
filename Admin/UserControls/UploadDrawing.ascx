<%@ Control Language="C#" AutoEventWireup="true" CodeFile="UploadDrawing.ascx.cs" Inherits="Admin_UserControls_UploadDrawing" %>
<script type="text/javascript">
 ...
 <asp:HiddenField ID="hdnDrawingID" runat="server" />
    <asp:HiddenField ID="hdnIsAdmin" runat="server" />
     ...
     <div  style="display: none; width:400px; height:200px;" id="progress">
        <table style="text-align:center">
            <tr>
                <td style="text-align:center">
                    <img src="img/animated.gif" style="width:30px; height:30px;" />
                </td>
            </tr>
            <tr>
                <td class="control-label">Please Wait while Drawing is uploading....
                </td>
            </tr>
        </table>
    </div>
