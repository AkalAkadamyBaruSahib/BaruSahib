<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BodyAdmin_ParticularEstimateView.ascx.cs" Inherits="Admin_UserControls_BodyAdmin_ParticularEstimateView" %>
                                ...
                                <tr>
                                    <td width="50%" colspan="2">
                                        <div class="control-group">
                                            <h2>
                                                <asp:Label ID="lblWorkAllotName" runat="server"></asp:Label></h2>
                                        </div>
                                    </td>
