<%@ Page Title="" Language="C#" MasterPageFile="~/AuditMaster.master" AutoEventWireup="true" CodeFile="Audit_WorkWiseBill.aspx.cs" Inherits="Audit_WorkWiseBill" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
                        ...
                        <tr>
                            <td >
                                ...
                                <a href="Audit_BillStatusZYMWise.aspx"><span class="label label-info" style="font-size:medium;">Month & Year Wise</span></a>
                                 &nbsp;&nbsp;&nbsp;
                                <a href="Audit_WorkWiseBill.aspx"><span class="label label-info" style="font-size:medium;">Paid Bills</span></a>
                                 &nbsp;&nbsp;&nbsp;
    ...
    <div class="modal hide fade" id="myModal">
        ...
        <div class="modal-footer">
            ...
            <asp:Button ID="Button1" Text="Submit Details" CssClass="btn btn-primary" runat="server"  OnClientClick="return confirmation();"/>
            <asp:Button ID="Button2" Text="Reject Bill" CssClass="btn btn-danger" runat="server" OnClientClick="return confirmation();" />
